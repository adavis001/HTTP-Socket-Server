...
const server = net.createServer(request => {
	...
	request.on('data', (data) => {
		...
		//console.log('method, path, httpVersion ', method, path,httpVersion);

		let headersAndBody = `HTTP/2.2 200 OK
...
const cssStyles = `@import url(http://fonts.googleapis.com/css?family=Open+Sans|Roboto+Slab);
